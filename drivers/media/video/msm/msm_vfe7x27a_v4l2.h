...
typedef enum {
    SPIN_LOCK_DBG_VFE_START_0 = 0,
    SPIN_LOCK_DBG_VFE_START_1,
    SPIN_LOCK_DBG_VFE_START_2,
    SPIN_LOCK_DBG_VFE_STOP_0,
    SPIN_LOCK_DBG_VFE_STOP_1,
    SPIN_LOCK_DBG_VFE_STOP_2,	
    SPIN_LOCK_DBG_VFE_UPDATE_0,
    SPIN_LOCK_DBG_VFE_UPDATE_1,
    SPIN_LOCK_DBG_VFE_UPDATE_2,
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_0,
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_1,		
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_2,
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_3,
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_4,
    SPIN_LOCK_DBG_VFE_CONFIG_SEND_5,
    SPIN_LOCK_DBG_MSG_TABLE_CMD_ACK_0,	
    SPIN_LOCK_DBG_MSG_TABLE_CMD_ACK_1,
    SPIN_LOCK_DBG_MSG_TABLE_CMD_ACK_2,
    SPIN_LOCK_DBG_MSG_TABLE_CMD_ACK_3,
    SPIN_LOCK_DBG_MAX,
}SPIN_LOCK_TYPE;
