...
static int	mt9v113_mirror_flip_setting(void)
{
	int rc = 0;

	if (mt9v113_s_ctrl.mirror_flip == CAMERA_SENSOR_MIRROR_FLIP)
	{
	...
	else if (mt9v113_s_ctrl.mirror_flip == CAMERA_SENSOR_MIRROR)
	{
	...
	else if (mt9v113_s_ctrl.mirror_flip == CAMERA_SENSOR_FLIP)
	{
...
init_fail:
	pr_err("Error!! mt9v113_mirror_flip_setting failed!\n");
	return rc;
...
static int mt9v113_reg_init(void)
{
	...
	if (mt9v113_mirror_flip_setting() < 0)
	  goto reg_init_fail;
