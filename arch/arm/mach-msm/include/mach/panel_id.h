...
#define PANEL_ID_URANUS_JDI_NOVATEK (0x7A | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_LUPUS_JDI_NT (0x7B | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_LUPUS_AUO_NT (0x7C | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_LUPUS_AUO_NT_C2 (0x7C | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY | REV_1)
#define PANEL_ID_NAIAD_JDI_NT (0x82 | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_NAIAD_AUO_NT (0x83 | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_NAIAD_AUO_NT_C2 (0x83 | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY | REV_1)
