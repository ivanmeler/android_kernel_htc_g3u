...
#define MODULE_PARAM_PREFIX "board_g3u."

module_param_named(keycaps, keycaps, charp, 0);

#define G3U_POWER_KEY                (37)
#define G3U_GPIO_VOL_DOWN            (48)
#define G3U_GPIO_VOL_UP              (86)
...
static struct gpio_event_direct_entry msm8625_keypad_nav_map[] = {
	...
	{
		.gpio = G3U_GPIO_VOL_DOWN,
		.code = KEY_VOLUMEDOWN,
	},
	{
		.gpio = G3U_GPIO_VOL_UP,
		.code = KEY_VOLUMEUP,
	},
};
...
static void msm8625_direct_inputs_gpio(void)
{
	static uint32_t matirx_inputs_gpio_table[] = {
		GPIO_CFG(G3U_POWER_KEY, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,	GPIO_CFG_4MA),
		GPIO_CFG(G3U_GPIO_VOL_DOWN, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
		GPIO_CFG(G3U_GPIO_VOL_UP, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
	};
